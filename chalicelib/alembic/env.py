...
# fastapi_backend/ must precede imports: `chalicelib` is the in-repo app package (not PyPI/Chalice).
_FA_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir))
...
from chalicelib.schema.models import Base
